...
public record LegacyWorldSize(ResourceLocation id, Component name, Consumer<ApplyContext> applier) {
    ...
    public static final LegacyWorldSize CLASSIC = register(new LegacyWorldSize(LegacyWorldSizes.createModLocation("classic"), LegacyWSComponents.optionName("worldSizes.classic"), ctx -> {
        LWSWorldOptions.legacyLevelLimits.set(Map.of(Level.OVERWORLD, new LegacyLevelLimit(List.of(new LegacyLevelLimit.ChunkBounds(new ChunkPos(-27, -27), new ChunkPos(27, 27))), true, getChunkContent(ctx), Optional.of(ctx.registry().getOrThrow(Biomes.PLAINS)), false), Level.NETHER, new LegacyLevelLimit(List.of(new LegacyLevelLimit.ChunkBounds(new ChunkPos(-9, -9), new ChunkPos(9, 9))), false, FakeLevelChunk.ContentType.NONE, Optional.empty(), true), Level.END, new LegacyLevelLimit(List.of(new LegacyLevelLimit.ChunkBounds(new ChunkPos(-6, -6), new ChunkPos(6, 6))), false, FakeLevelChunk.ContentType.NONE, Optional.empty(), false)));
    ...
    public static final LegacyWorldSize SMALL = register(new LegacyWorldSize(LegacyWorldSizes.createModLocation("small"), LegacyWSComponents.optionName("worldSizes.small"), ctx -> {
        LWSWorldOptions.legacyLevelLimits.set(Map.of(Level.OVERWORLD, new LegacyLevelLimit(List.of(new LegacyLevelLimit.ChunkBounds(new ChunkPos(-32, -32), new ChunkPos(32, 32))), true, getChunkContent(ctx), Optional.of(ctx.registry().getOrThrow(Biomes.PLAINS)), false), Level.NETHER, new LegacyLevelLimit(List.of(new LegacyLevelLimit.ChunkBounds(new ChunkPos(-11, -11), new ChunkPos(11, 11))), false, FakeLevelChunk.ContentType.NONE, Optional.empty(), true), Level.END, new LegacyLevelLimit(List.of(new LegacyLevelLimit.ChunkBounds(new ChunkPos(-6, -6), new ChunkPos(6, 6))), false, FakeLevelChunk.ContentType.NONE, Optional.empty(), false)));
    ...
    public static final LegacyWorldSize MEDIUM = register(new LegacyWorldSize(LegacyWorldSizes.createModLocation("medium"), LegacyWSComponents.optionName("worldSizes.medium"), ctx -> {
        LWSWorldOptions.legacyLevelLimits.set(Map.of(Level.OVERWORLD, new LegacyLevelLimit(List.of(new LegacyLevelLimit.ChunkBounds(new ChunkPos(-96, -96), new ChunkPos(96, 96))), true, getChunkContent(ctx), Optional.of(ctx.registry().getOrThrow(Biomes.PLAINS)), false), Level.NETHER, new LegacyLevelLimit(List.of(new LegacyLevelLimit.ChunkBounds(new ChunkPos(-16, -16), new ChunkPos(16, 16))), false, FakeLevelChunk.ContentType.NONE, Optional.empty(), true), Level.END, new LegacyLevelLimit(List.of(new LegacyLevelLimit.ChunkBounds(new ChunkPos(-6, -6), new ChunkPos(6, 6))), false, FakeLevelChunk.ContentType.NONE, Optional.empty(), false)));
        LWSWorldOptions.maxEndGateways.set(4);
        LWSWorldOptions.endOuterIslandsRay.set(128);
        LWSWorldOptions.endSpawnPoint.set(LEGACY_END_SPAWN_POINT);
        LWSWorldOptions.legacyEndSpikes.set(true);
    ...
    public static final LegacyWorldSize LARGE = register(new LegacyWorldSize(LegacyWorldSizes.createModLocation("large"), LegacyWSComponents.optionName("worldSizes.large"), ctx -> {
        LWSWorldOptions.legacyLevelLimits.set(Map.of(Level.OVERWORLD, new LegacyLevelLimit(List.of(new LegacyLevelLimit.ChunkBounds(new ChunkPos(-160, -160), new ChunkPos(160, 160))), true, getChunkContent(ctx), Optional.of(ctx.registry().getOrThrow(Biomes.PLAINS)), false), Level.NETHER, new LegacyLevelLimit(List.of(new LegacyLevelLimit.ChunkBounds(new ChunkPos(-20, -20), new ChunkPos(20, 20))), false, FakeLevelChunk.ContentType.NONE, Optional.empty(), true), Level.END, new LegacyLevelLimit(List.of(new LegacyLevelLimit.ChunkBounds(new ChunkPos(-6, -6), new ChunkPos(6, 6))), false, FakeLevelChunk.ContentType.NONE, Optional.empty(), false)));
        LWSWorldOptions.maxEndGateways.set(4);
        LWSWorldOptions.endOuterIslandsRay.set(128);
        LWSWorldOptions.endSpawnPoint.set(LEGACY_END_SPAWN_POINT);
        LWSWorldOptions.legacyEndSpikes.set(true);
